...
template_path = r"C:\ASD11\The data frame file to be analyzed.xlsx"
...
def train_and_save_model():
    data_path = r"C:\ASD11\final_classified_loss_with_reasons_60_percent_ordered.xlsx"
...
def analyze_data(data, model):
    try:
        ...
        output_path = r"C:\ASD11\analyzed_data_loss_only.xlsx"
...
# Streamlit UI
st.title("Energy Loss Prediction System with RandomForest")
